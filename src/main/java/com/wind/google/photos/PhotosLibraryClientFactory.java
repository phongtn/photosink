...
public class PhotosLibraryClientFactory {
    ...
    final static Logger logger = LoggerFactory.getLogger(PhotosLibraryClientFactory.class.getName());
    ...
    public static PhotosLibraryClient createClient(
        ...
        PhotosLibrarySettings settings =
                PhotosLibrarySettings.newBuilder().
                        setCredentialsProvider(FixedCredentialsProvider.create(getUserCredentials(credentialsPath, selectedScopes))).build();
    ...
    private static Credentials getUserCredentials(String credentialsPath, List<String> selectedScopes)
        ...
        logger.info("refresh token {} {}", credential.getAccessToken(), credential.getRefreshToken());
